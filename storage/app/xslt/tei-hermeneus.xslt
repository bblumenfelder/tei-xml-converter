<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="//tei:teiHeader">
        <div id="hermeneus-textinfo">
            <div class="hermeneus-textinfo__default">
                ...
                <div class="hermeneus-textinfo__default-author-short">
                    <xsl:text> </xsl:text>
                </div>
    ...
    <xsl:template match="//tei:body">
        ...
        <xsl:element name="div" namespace="http://www.tei-c.org/ns/1.0">
            <xsl:attribute name="id">hermeneus-farben</xsl:attribute>
    ...
    <xsl:template match="//tei:pc">
        <xsl:element name="{local-name()}" namespace="http://www.tei-c.org/ns/1.0">
            ...
            <xsl:if test="self::tei:pc[@pre = 'true' or @pre = '1']">
                <xsl:attribute name="pre">true</xsl:attribute>

                <xsl:text>&#8239;</xsl:text>
            </xsl:if>
            
            
            <xsl:if test="self::tei:pc[@join = 'no']">
                <xsl:attribute name="join">no</xsl:attribute>
