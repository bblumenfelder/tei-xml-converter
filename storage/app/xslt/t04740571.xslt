<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="transformation-steps/remove_foreign_tags.xslt"/>
    <xsl:include href="transformation-steps/remove_quote_tags.xslt"/>
    <xsl:include href="transformation-steps/remove_reg_tags.xslt"/>
</xsl:stylesheet>
