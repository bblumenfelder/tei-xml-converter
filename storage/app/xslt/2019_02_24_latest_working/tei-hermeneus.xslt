<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="//tei:teiHeader">
        <div id="hermeneus-textinfo">
            <div class="hermeneus-textinfo__default">
                ...
                <div class="hermeneus-textinfo__default-author-short">Cat</div>
    ...
    <xsl:template name="words" match="//tei:w">
        ...
        <xsl:element name="{local-name()}" namespace="http://www.tei-c.org/ns/1.0">
            ...
            <!-- Include a narrow space BEFORE the word-->
            <xsl:if test="not(preceding-sibling::*[1][self::tei:pc[@type = 'quotation']])">
                <xsl:text>&#8239;</xsl:text>
            </xsl:if>
        ...
        <xsl:element name="{local-name()}" namespace="http://www.tei-c.org/ns/1.0">
            ...
            <xsl:if
                test="
                    ...
                    and not(self::tei:pc[@type = 'quotation'])
